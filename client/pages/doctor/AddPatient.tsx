...
import { useAppState, PatientProfile, ConsultRequest } from "@/context/app-state";
...
export default function AddPatient() {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    const profile: PatientProfile = {
      ...
      notes: form.notes,
      documents: files.map((f) => ({ name: f.name, url: URL.createObjectURL(f) })),
    };
    ...
    <div className="container mx-auto py-8">
      ...
      <Card className="border-t-4 border-t-primary">
        <CardHeader>
          ...
          <CardDescription>Fill in the patient's information and upload documents</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                <Label>Dosha</Label>
                <Select value={form.dosha} onValueChange={(v) => setForm((f) => ({ ...f, dosha: v }))}>
                  <SelectTrigger>
              ...
              <div>
                ...
                <Input id="height" name="height" type="number" min="0" value={form.height} onChange={onChange} />
              </div>
              <div>
                <Label htmlFor="weight">Weight (kg)</Label>
                <Input id="weight" name="weight" type="number" min="0" value={form.weight} onChange={onChange} />
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="md:col-span-2">
                ...
                <Textarea id="lifestyle" name="lifestyle" value={form.lifestyle} onChange={onChange} />
              </div>
              <div>
                <Label htmlFor="medicalHistory">Medical History</Label>
                <Textarea id="medicalHistory" name="medicalHistory" value={form.medicalHistory} onChange={onChange} />
              </div>
              <div>
                <Label htmlFor="allergies">Allergies</Label>
                <Textarea id="allergies" name="allergies" value={form.allergies} onChange={onChange} />
              </div>
              <div>
                <Label htmlFor="conditions">Conditions</Label>
                <Textarea id="conditions" name="conditions" value={form.conditions} onChange={onChange} />
              </div>
              <div>
                <Label htmlFor="medications">Medications</Label>
                <Textarea id="medications" name="medications" value={form.medications} onChange={onChange} />
              </div>
              <div>
                <Label htmlFor="sleepPattern">Sleep Pattern</Label>
                <Input id="sleepPattern" name="sleepPattern" value={form.sleepPattern} onChange={onChange} />
              </div>
              <div>
                <Label htmlFor="digestion">Digestion</Label>
                <Input id="digestion" name="digestion" value={form.digestion} onChange={onChange} />
              </div>
              <div>
